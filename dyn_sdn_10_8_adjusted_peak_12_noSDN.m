...
iter_vec=M/4;
%V_vec=[.5,1,2,5];
V_vec=1e2;%not used in noSDN mode
        ...
        for mm=1:M
            ...
            if(mod(floor(mm/1e3),2)==0)
                ...
                if(mod(mm,2e3)==0)
                    ...
                    %OLD intermediate assignment of resources K and update of queues                 
                    ...
                    for ss=1:Num_G
                        ...
                        if(isempty(idx_stop_assign))
                          %  lambda_gamma(ss,oo)=0;
                            ...
                            lambda_gamma(ss,oo)=min(lambda_gamma(ss,oo),Kbar)/Kbar;%ADDED FOR STABILITY 
                        end
                    end
                end
            end
...
%save('lorenzo_10_8_retuned_peak_12_noSDN')